...
model = YOLO("scripts/yolov5m6.pt", device=None)
...
# Initalize a subscriber to the "mybot/camera/image_raw" topic with the function "image_callback" as a callback
ub_image = rospy.Subscriber("/front_cam/camera/image", Image, image_callback)
